...
def log():
    ...
    result = db.collection4.find_one(query) #retrieve stored feature set from database
...
def reg():
    ...
    try:
        insert_result = db.collection4.insert_one({"length": length, "description": description, "user_id": user_id})
